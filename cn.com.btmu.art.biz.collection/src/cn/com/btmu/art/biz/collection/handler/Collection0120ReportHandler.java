...
import cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollection0120Impl;
...
public class Collection0120ReportHandler extends AbstractComReportQueryHandler {
   ...
   */
  public void getCSV() {
    logger.debug("Collection0120ReportHandler-getCSV start");
    ...
    qm.setQueryObjectClass(QOCollection0120.class);
    ...
    //帐票ID
    csv.add(ComBizConstant.COMMON_REPORT_ID_ONE_HUNDRED_TWENTY);
    //帐票保存路径
    ...
    for (DataObject qo : resultList) {
      QOCollection0120Impl  dojb = (QOCollection0120Impl) qo;
      recNo = recNo + 1;
      if (recNo == 1
    ...
    logger.debug("Collection0120ReportHandler-getCSV end");
  }
