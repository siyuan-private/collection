 ...
 * <ul>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getTKind <em>TKind</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getTxnPrmryRefNo <em>TxnPrmryRefNo</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getTxnSubRefNo <em>TxnSubRefNo</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getBeneCif <em>BeneCif</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getBeneName <em>BeneName</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getBxCcy <em>BxCcy</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getBxAmt <em>BxAmt</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getTenorType <em>TenorType</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getDueDate <em>DueDate</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getNatnlty <em>Natnlty</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getFaultNo <em>FaultNo</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getDomstcLcFlg <em>DomstcLcFlg</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getPerfmConfmDuties <em>PerfmConfmDuties</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getCommonBizStatus <em>CommonBizStatus</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getCommonOperSn <em>CommonOperSn</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getCommonOperStatus <em>CommonOperStatus</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getCommonOper <em>CommonOper</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getCommonPriceStatus <em>CommonPriceStatus</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getCollDate <em>CollDate</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getIvcNo <em>IvcNo</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getLcFlg <em>LcFlg</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getBpoFlg <em>BpoFlg</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getTsuFlg <em>TsuFlg</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getLcNo <em>LcNo</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getExpImptrName <em>ExpImptrName</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getBcImptrName <em>BcImptrName</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getExpDispch <em>ExpDispch</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getNonExpDispch <em>NonExpDispch</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getAccptceRegDate <em>AccptceRegDate</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getAccptceDueDate <em>AccptceDueDate</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getPosDate <em>PosDate</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getOurBankToCustBookingDate <em>OurBankToCustBookingDate</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getPosCcy <em>PosCcy</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getPosAmt <em>PosAmt</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getTheirDedctCcy <em>TheirDedctCcy</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getTheirDedctAmt <em>TheirDedctAmt</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getPpnegoFlg <em>PpnegoFlg</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getTelegNegoFlg <em>TelegNegoFlg</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getTelegNegoClsDate <em>TelegNegoClsDate</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getBcRmrk <em>BcRmrk</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getRegDate <em>RegDate</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getModChgbkRmrk <em>ModChgbkRmrk</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getFakeForwdFlg <em>FakeForwdFlg</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getExpOsa <em>ExpOsa</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getReimbBankName <em>ReimbBankName</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getBcOsa <em>BcOsa</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getDishnrNo <em>DishnrNo</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getAccptceRmrk <em>AccptceRmrk</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getBookRmrk <em>BookRmrk</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getResn <em>Resn</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getLcBalCcy <em>LcBalCcy</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getLcBalAmt <em>LcBalAmt</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getFaultTKind <em>FaultTKind</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getFaultTxnTKind <em>FaultTxnTKind</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getDishnrTKind <em>DishnrTKind</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getDishnrTxnTKind <em>DishnrTxnTKind</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getCommonBranchCode <em>CommonBranchCode</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getCommonBizGroupId <em>CommonBizGroupId</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getMaintType <em>MaintType</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getCommonOperInfoNo <em>CommonOperInfoNo</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getCommonAfterwardsStatus <em>CommonAfterwardsStatus</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getCommonMakerId <em>CommonMakerId</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getCommonOperVerNo <em>CommonOperVerNo</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getCommBizNo <em>CommBizNo</em>}</li>
 *   <li>{@link cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollectionBizImpl#getCommonCurrOper <em>CommonCurrOper</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements QOCollectionBiz;
 */

public class QOCollectionBizImpl extends ExtendedDataObjectImpl implements QOCollectionBiz {
	/**
	...
	public final static int INDEX_COMMONBIZSTATUS = 13;
	public final static int INDEX_COMMONOPERSN = 14;
	public final static int INDEX_COMMONOPERSTATUS = 15;
	public final static int INDEX_COMMONOPER = 16;
	public final static int INDEX_COMMONPRICESTATUS = 17;
	...
	public final static int INDEX_COMMONOPERVERNO = 62;
	public final static int INDEX_COMMBIZNO = 63;
	public final static int INDEX_COMMONCURROPER = 64;
	public final static int SDO_PROPERTY_COUNT = 65;
	 ...
	 * <!-- end-user-doc -->
	 */
	public QOCollectionBizImpl(Type type) {
		super(type);
	}
