...
import cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollection0121Impl;
...
public class Collection0121ReportHandler extends AbstractComReportQueryHandler {
   ...
   */
  public void getCSV() {
    logger.debug("Collection0121ReportHandler-getCSV start");
    ...
    qm.setQueryObjectClass(QOCollection0121.class);
    ...
    //帐票ID
    csv.add(ComBizConstant.COMMON_REPORT_ID_ONE_HUNDRED_TWENTY_ONE);
    //帐票保存路径
    ...
    for (DataObject qo : resultList) {
      QOCollection0121Impl  dojb = (QOCollection0121Impl) qo;
      recNo = recNo + 1;
      if (recNo == 1
      ...
      // 信用证编号
      csv.add(ArtStringUtil.nullConvert(dojb.getLcNo()));
      // 收件人
    ...
    logger.debug("Collection0121ReportHandler-getCSV end");
  }
