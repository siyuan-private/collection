...
/**
 * R823001 托收业务规则配置（R-823-001）.
 * 
 * @author ivision
 * @version 1.0.0
 */
public class R823001 implements ICalculateByClass {
  ...
  public boolean execute(IArtContext arg0) {
	  logger.debug("R823001-executeRuleForCls start");
	  ...
	  logger.debug("R823001-executeRuleForCls end");
	  return (DataTypeConstant.DATA_TYPE_NO.equals(acceptedFlg));
  }
}
