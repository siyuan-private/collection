...
/**
 * CollectionCollCreateForCollModfDataBuilder
 * 
 * 托收新建节点数据（修正操作时）转换用DataBuilder.
 * 
 * @author ivision
 * @version 1.0.0
 */
public class CollectionCollCreateForCollModfDataBuilder
    extends
  ...
  protected void registBuildInVisitor(BcMntnOpDtlVO vo,
    ...
    logger
        .debug("CollectionCollCreateForCollModfDataBuilder-registBuildInVisitor start");
    ...
    putBuildInVisitor(context.getDataRepository().getOperationDataCollection()
        ...
        .getInstance());
    logger
        .debug("CollectionCollCreateForCollModfDataBuilder-registBuildInVisitor end");
  }
  ...
  protected void registBuildOutFromBizVisitor(
      CollectionCollModfDetailContext context) {
    logger
        .debug("CollectionCollCreateForCollModfDataBuilder-registBuildOutFromBizVisitor start");
    ...
    logger
        .debug("CollectionCollCreateForCollModfDataBuilder-registBuildOutFromBizVisitor end");
  }
  ...
  protected void registBuildOutFromOperVisitor(
      CollectionCollModfDetailContext context) {
    logger
        .debug("CollectionCollCreateForCollModfDataBuilder-registBuildOutFromOperVisitor start");
    ...
    logger
        .debug("CollectionCollCreateForCollModfDataBuilder-registBuildOutFromOperVisitor end");
  }
