...
/** 
 * NoticeLetterNoticeLetterAjaxForModifyDataBuilder  
 * 通知书打印修改节点用DataBuilder.
 * 
 * @author iVision
 * @version 1.0.0
 */
public class NoticeLetterNoticeLetterAjaxForModifyDataBuilder implements
  ...
  public void buildInput(BbNoticeLettInfoVO vo,
    ...
    logger
        .debug("NoticeLetterNoticeLetterAjaxForModifyDataBuilder-buildInput start");
    // VO为空时返回，不进行后面的属性赋值操作
    if (vo == null) {
      logger
          .debug("NoticeLetterNoticeLetterAjaxForModifyDataBuilder-buildInput vo为空！");
      logger
          .debug("NoticeLetterNoticeLetterAjaxForModifyDataBuilder-buildInput end");
      return;
    }
  ...
  public Object buildOutput(NoticeLetterNoticeLetterAjaxContext context,
    ...
    logger
        .debug("NoticeLetterNoticeLetterAjaxForModifyDataBuilder-buildOutput start");
    //定义要返回的通知书打印信息的VO
    ...
    logger
        .debug("NoticeLetterNoticeLetterAjaxForModifyDataBuilder-buildOutput end");
    //返回VO
    return vo;
  }
