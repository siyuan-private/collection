...
import cn.com.btmu.art.biz.collection.dataset.collection.impl.QOCollection0119Impl;
...
public class Collection0119ReportHandler extends AbstractComReportQueryHandler {
  ...
  @Override
  public void getCSV() {
    logger.debug("Collection0119ReportHandler-getCSV start");
    ...
    qm.setQueryObjectClass(QOCollection0119.class);
    ...
    //帐票ID
    csv.add(ComBizConstant.COMMON_REPORT_ID_ONE_HUNDRED_NINETEEN);
    //帐票保存路径
    ...
    for (DataObject qo : resultList) {
      QOCollection0119Impl  dojb = (QOCollection0119Impl) qo;
      recNo = recNo + 1;
      if (recNo == 1
      ...
      // 登记日期
      csv.add(ArtStringUtil.nullConvert(dateUtil.toString(dojb.getRegDate(),
          ComBizConstant.COMMON_REPORT_DATE_FORMAT_PATTERN1)));
      // 交易参号
    ...
    logger.debug("Collection0119ReportHandler-getCSV end");
  }
