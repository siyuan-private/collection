 ...
 * @version 1.0.0
 */
public class SpValidate82302001 extends AbstractBizCheckUnit<BigDecimal> {
	...
	public SpValidate82302001(String locale, String label) {
	 ...
	 */
	@Override
	protected boolean canExecute(BigDecimal value) {
	 ...
	 */
	@Override
	protected void doCheckLogic(BigDecimal value, ErrorContainer errorContainer) {
