...
/**
 * CollectionCollCreateForCollModDocForCompareDataBuilder
 * 
 * 托收新建节点数据（改单操作时）转换用ForCompareDataBuilder.
 * 
 * @author ivision
 * @version 1.0.0
 */
public class CollectionCollCreateForCollModDocForCompareDataBuilder
    extends
  ...
  protected void registBuildOutFromBizVisitor(
      CollectionCollModDocDetailContext context) {
    logger
        .debug("CollectionCollCreateForCollModDocForCompareDataBuilder-registBuildOutFromBizVisitor start");
    ...
    logger
        .debug("CollectionCollCreateForCollModDocForCompareDataBuilder-registBuildOutFromBizVisitor end");
  }
